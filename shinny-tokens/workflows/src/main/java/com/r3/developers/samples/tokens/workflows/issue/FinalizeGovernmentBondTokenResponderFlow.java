...
public class FinalizeGovernmentBondTokenResponderFlow implements ResponderFlow {
    private final static Logger log = LoggerFactory.getLogger(FinalizeGovernmentBondTokenResponderFlow.class);
