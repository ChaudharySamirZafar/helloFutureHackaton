...
public class FinalizeGovernmentBondTokenSubFlow implements SubFlow<String> {

    private final static Logger log = LoggerFactory.getLogger(FinalizeGovernmentBondTokenSubFlow.class);
    private final UtxoSignedTransaction signedTransaction;
    private final MemberX500Name otherMember;

    public FinalizeGovernmentBondTokenSubFlow(UtxoSignedTransaction signedTransaction, MemberX500Name otherMember) {
